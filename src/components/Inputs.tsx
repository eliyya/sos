...
export const CompletInput = forwardRef<HTMLInputElement, CompletInputProps>(
    (
        { children, label, required, error, id, className, icon, ...props },
        ref,
    ) => {
        const Icon = icon
        const rid = useId()
...
>(
    (
        { children, label, id, required, error, className, icon, ...props },
        ref,
    ) => {
        const Icon = icon
        const rid = useId()
...
>(
    (
        { children, label, onChange, id, error, defaultValue, icon, ...props },
        ref,
    ) => {
        const Icon = icon
        const rid = useId()
